...
from app.helpers.entry_crud import delete_entry
from app.models.Income import IncomeFixed, Income
from app.helpers import get_entry_or_404, handle_installments_split, handle_entry_migration_or_update
...
def update_income(
    ...
    return handle_entry_migration_or_update(
        session, IncomeFixed, Income, entry_id, entry, is_fixed, installments, "Income not found"
    )
